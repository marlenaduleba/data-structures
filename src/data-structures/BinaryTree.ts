 ...
 */
   ...
   * @private
   */
    private inOrderTraverseNode(node: TreeNode<T> | null, callback: (value: T) => void): void {
      if (node !== null) {
   ...
   * @private
   */
    private preOrderTraverseNode(node: TreeNode<T> | null, callback: (value: T) => void): void {
      if (node !== null) {
        callback(node.value);
   ...
   * @private
   */
    private postOrderTraverseNode(node: TreeNode<T> | null, callback: (value: T) => void): void {
      if (node !== null) {
